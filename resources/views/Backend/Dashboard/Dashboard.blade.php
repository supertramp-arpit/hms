                ...
                <ul>
                    <li>
                        <div class="ad-hom-box ad-hom-box-1">
                            <span class="ad-hom-col-com ad-hom-col-2"><i class="fa fa-bar-chart"></i></span>
                            <div class="ad-hom-view-com">
                            <p><i class="fa  fa-arrow-up up"></i>Available Rooms</p>
                            <h3>22,520</h3>
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="ad-hom-box ad-hom-box-2">
                            ...
                            <div class="ad-hom-view-com">
                            <p><i class="fa  fa-arrow-up up"></i>Pending Rooms</p>
                            <h3>22,520</h3>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="ad-hom-box ad-hom-box-3">
                            ...
                            <div class="ad-hom-view-com">
                            <p><i class="fa  fa-arrow-up up"></i>Booked Rooms</p>
                            <h3>22,520</h3>
                            </div>
                        </div>
                    </li>
...
@extends('Backend.Layouts.Main', ['admin' => $admin])
@section('content')
<div class="sb2-2" style="background-image: url('{{ asset('assets/images/bgimage.jpg') }}'); background-size: cover; background-position: center;">
    <div class="ad-v2-hom-info">
        <div class="ad-v2-hom-info-inn">
            <ul>
                <li>
                    <div class="ad-hom-box ad-hom-box-1">
                        <span class="ad-hom-col-com ad-hom-col-2"> <i class="fa fa-user"></i></span>
                        <div class="ad-hom-view-com">
                            <p><i class="fa fa-arrow-up up"></i>Guests</p>
                            <h3>{{ $guestCount }}</h3>
                        </div>
                    </div>
                </li>
            <li>
                    <div class="ad-hom-box ad-hom-box-2">
                        <span class="ad-hom-col-com ad-hom-col-2"> <i class="fa fa-home"></i></span>
                        <div class="ad-hom-view-com">
                ...
                <li>
                    <div class="ad-hom-box ad-hom-box-3">
                        <span class="ad-hom-col-com ad-hom-col-3"> <i class="fa fa-bed"></i></span>
                        <div class="ad-hom-view-com">
                            <p><i class="fa fa-arrow-up up"></i>Total Rooms</p>
                            <h3>{{ $roomCount }}</h3>
                        </div>
                    </div>
                </li>
