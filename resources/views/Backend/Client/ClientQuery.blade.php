                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($item->status == '1')
                                        <td><span class="label label-primary"><a href="{{url('client-active').'/'.$item->id ?? ''}}" style="color: white;">Active</a></span></td>
                                        @elseif ($item->status == '2')
                                        <td><span class="label label-danger"><a href="{{url('client-block').'/'.$item->id ?? ''}}" style="color: white;">Blocked</a></span></td>
                                        @endif
                                    
                                        <td>
                                            <a href="{{url('client-delete').'/'.$item->id ?? ''}}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        </td>
