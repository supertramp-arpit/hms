...
<body>
    <section class="front-section container-fluid px-0" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0,0,0,0.5)), url({{ asset('user/img/pic/bg-img.png') }}); background-repeat: no-repeat; background-size: 100% 100%;">
...
@else
    ...
    <img src="{{ asset('user/img/pic/default.png') }}" alt="{{ Auth::user()->name }}'s Profile Picture" style="width: 40px; height: 40px;"  id="logo" class="rounded-circle">
@endif
@endif
