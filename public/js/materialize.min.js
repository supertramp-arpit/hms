...
(jQuery.easing.jswing = jQuery.easing.swing),
                      ...
                      (c.fn = c.prototype =
                          {
                              ...
                              position: function () {
                                  ...
                                  return (
                                      (d.top -=
                                          parseFloat(b.style.marginTop) || 0),
                                      (d.left -=
                                          parseFloat(b.style.marginLeft) || 0),
                                      a.style &&
                                          ((e.top +=
                                              parseFloat(
                                                  a.style.borderTopWidth
                                              ) || 0),
                                          (e.left +=
                                              parseFloat(
          ...
          (function (a) {
              ...
              return (function (a, b, c, d) {
                  ...
                  (t.Easings = {
                      ...
                      spring: function (a) {
                          return (
                              1 - Math.cos(4.5 * a * Math.PI) * Math.exp(6 * -a)
                          );
                      },
                  }),
                      m.each(
                  ...
                  var v = (t.CSS = {
                          ...
                          extractValue: function (a, b) {
                              ...
                              if (c) {
                                  var d = c[0],
                                      e = c[1];
                                  return (
                                      (b = v.Hooks.cleanRootPropertyValue(
                                          d,
                                          b
                                      )),
                          ...
                          injectValue: function (a, b, c) {
                              ...
                              if (d) {
                                  var e,
                                      ...
                                      h = d[1];
                                  return (
                                      (c = v.Hooks.cleanRootPropertyValue(
                                          g,
                                          c
                                      )),
                                      (e = c
                                          .toString()
                                          .match(v.RegEx.valueSplit)),
                                      (e[h] = b),
                                      (f = e.join(" "))
                                  );
                              }
                      ...
                      Normalizations: {
                          ...
                          register: function () {
                              ...
                              for (
                                  var a = 0;
                                  a < v.Lists.transformsBase.length;
                                  a++
                              )
                                  !(function () {
                                      var b = v.Lists.transformsBase[a];
                                      v.Normalizations.registered[b] =
                                          function (a, c, e) {
                                              switch (a) {
                                                  case "name":
                                                      return "transform";
                          ...
                          prefixCheck: function (a) {
                              ...
                              for (
                                  ...
                                  if (
                                      ...
                                      p.isString(
                                          t.State.prefixElement.style[e]
                                      ))
                                  )
                                      return (
                                          (t.State.prefixMatches[a] = e),
                                          [e, !0]
                                      );
                              }
                              return [a, !1];
    ...
    !(function (a, b, c, d) {
        ...
        function P(a, b) {
            ...
            return (
                b & (Aa | Ba) && (c = u(c.concat(d), "identifier", !0)), [c, d]
            );
        }
        function Q() {
            (this.evTarget = Xa),
        ...
        y.prototype = {
            ...
            init: function () {
                this.evEl && n(this.element, this.evEl, this.domHandler),
                    this.evTarget &&
                        n(this.target, this.evTarget, this.domHandler),
                    this.evWin &&
        ...
        (V.prototype = {
            ...
            recognize: function (a) {
                ...
                return l(this.options.enable, [this, b])
                    ? (this.state & (ib | jb | kb) && (this.state = eb),
                      (this.state = this.process(b)),
                      void (
                          this.state & (fb | gb | hb | jb) && this.tryEmit(b)
                      ))
            ...
            j($, Z, {
                ...
                attrTest: function (a) {
                    return (
                        ...
                        (this.state & fb ||
                            (!(this.state & fb) && this.directionTest(a)))
                    );
                },
                emit: function (a) {
...
(Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity),
                ...
                this.each(function () {
                    ...
                    function g(a, c) {
                        c || a.toggleClass("active"),
                            b.accordion || "accordion" === n || void 0 === n
                                ? d(a)
                                : f(a),
                            h(a);
                    }
                    ...
                    k(),
                        ...
                        b.accordion || "accordion" === n || void 0 === n
                            ? g(m.filter(".active").first(), !0)
                            : m.filter(".active").each(function () {
                                  g(a(this), !0);
                              });
                })
            );
                    ...
                    : void this.each(function () {
                          function d() {
                              void 0 !== g.data("induration") &&
                                  (h.inDuration = g.data("induration")),
                                  void 0 !== g.data("outduration") &&
                                      (h.outDuration = g.data("outduration")),
                                  void 0 !== g.data("constrainwidth") &&
                                      (h.constrainWidth =
                                          g.data("constrainwidth")),
                                  void 0 !== g.data("hover") &&
                                      (h.hover = g.data("hover")),
                                  void 0 !== g.data("gutter") &&
                                      (h.gutter = g.data("gutter")),
                                  void 0 !== g.data("beloworigin") &&
                                      (h.belowOrigin = g.data("beloworigin")),
                                  void 0 !== g.data("alignment") &&
                                      (h.alignment = g.data("alignment")),
                                  void 0 !== g.data("stoppropagation") &&
                                      (h.stopPropagation =
                              ...
                              if (
                                  (s.is("body") ||
                                      (s[0].scrollHeight > s[0].clientHeight &&
                                          (q = s[0].scrollTop),
                                      s[0].scrollWidth > s[0].clientWidth &&
                                          (r = s[0].scrollLeft)),
                                  k + j.innerWidth() > a(window).width()
                                      ? (m = "right")
                                      : k - j.innerWidth() + g.innerWidth() <
                                            0 && (m = "left"),
                                  l + j.innerHeight() > c)
                              )
                          ...
                          if ((d(), g.after(j), h.hover)) {
                              ...
                              g.unbind("click." + g.attr("id")),
                                  ...
                                  g.on("mouseleave", function (b) {
                                      ...
                                      a(c).closest(".dropdown-content").is(j) ||
                                          (j.stop(!0, !0), f(), (k = !1));
                                  }),
                                  j.on("mouseleave", function (b) {
                                      var c = b.toElement || b.relatedTarget;
                                      a(c).closest(".dropdown-button").is(g) ||
                                          (j.stop(!0, !0), f(), (k = !1));
                                  });
                          } else
                              g.unbind("click." + g.attr("id")),
    ...
    (function (a) {
        ...
        a.fn.modal = function (b) {
            return e[b]
                ...
                : "object" != typeof b && b
                ? void a.error(
                      "Method " + b + " does not exist on jQuery.modal"
                  )
    ...
    (function (a) {
        var b = {
            init: function (b) {
                ...
                return this.each(function (c) {
                    ...
                    b.swipeable &&
                        l > b.responsiveThreshold &&
                        (b.swipeable = !1),
                        (e = a(m.filter('[href="' + location.hash + '"]'))),
                        0 === e.length &&
                            (e = a(this).find("li.tab a.active").first()),
                        0 === e.length &&
                            (e = a(this).find("li.tab a").first()),
                        e.addClass("active"),
                        (q = m.index(e)),
                        q < 0 && (q = 0),
                        void 0 !== e[0] &&
                            ((f = a(e[0].hash)), f.addClass("active")),
                        k.find(".indicator").length ||
                            k.append('<div class="indicator"></div>'),
                        (h = k.find(".indicator")),
                        k.append(h),
                        k.is(":visible") &&
                            setTimeout(function () {
                        ...
                        a(window)
                            .off("resize.tabs-" + j)
                            .on("resize.tabs-" + j, function () {
                                (n = k.width()),
                                    (p =
                                        Math.max(n, k[0].scrollWidth) /
                                        m.length),
                                    q < 0 && (q = 0),
                                    0 !== p &&
                                        0 !== n &&
                        ...
                        k.off("click.tabs").on("click.tabs", "a", function (c) {
                            ...
                            if (!a(this).attr("target")) {
                                ...
                                e.addClass("active"),
                                    ...
                                    q < 0 && (q = 0),
                                    b.swipeable
                                        ? o.length && o.carousel("set", q)
                                        : (void 0 !== f &&
                                              (f.show(),
                                              f.addClass("active"),
                                              "function" == typeof b.onShow &&
                                                  b.onShow.call(this, f)),
                                          void 0 === d ||
                                              d.is(f) ||
                                              (d.hide(),
        ...
        (a.fn.tabs = function (c) {
            return b[c]
                ...
                : "object" != typeof c && c
                ? void a.error("Method " + c + " does not exist on jQuery.tabs")
    ...
    (function (a) {
                ...
                : ((c = a.extend(e, c)),
                  this.each(function () {
                      var e = Materialize.guid(),
                          f = a(this);
                      f.attr("data-tooltip-id") &&
                          a("#" + f.attr("data-tooltip-id")).remove(),
        ...
        var b = function (b, c, d, e) {
            ...
            return (
                f < 0
                    ? (f = 4)
                    : f + d > window.innerWidth &&
                      (f -= f + d - window.innerWidth),
                g < 0
                    ? (g = 4)
                    : g + e > window.innerHeight + a(window).scrollTop &&
                      (g -= g + e - window.innerHeight),
                { x: f, y: g }
            );
        };
        a(document).ready(function () {
    ...
    (function (a) {
        ...
        function f(a) {
            ...
            for (
                var b = null, c = a.target || a.srcElement;
                ...
                if (
                    !(
                        ...
                        c.className.indexOf("waves-effect") === -1
                    )
                ) {
                    b = c;
                    break;
        ...
        function g(b) {
            ...
            null !== c &&
                (j.show(b, c),
                "ontouchstart" in a &&
                    (c.addEventListener("touchend", j.hide, !1),
                    ...
                    for (var b = 0; b < a.length; b++) {
                        ...
                        if ("input" === c.tagName.toLowerCase()) {
                            ...
                            if (
                                ...
                                d.className.indexOf("waves-effect") !== -1
                            )
                                continue;
        ...
        (h.displayEffect = function (b) {
            (b = b || {}),
                ...
                "ontouchstart" in a &&
                    document.body.addEventListener("touchstart", g, !1),
    ...
    (function (a) {
            ...
            init: function (b) {
                ...
                (b = a.extend(c, b)),
                    a(this).each(function () {
                        ...
                        b.draggable
                            ? (f.length && f.remove(),
                              (f = a('<div class="drag-target"></div>').attr(
                                  "data-sidenav",
                                  d
                              )),
                              a("body").append(f))
                                ...
                                .bind("pan", function (c) {
                                    if ("touch" == c.gesture.pointerType) {
                                        ...
                                        if (
                                            ...
                                            d <
                                            window.innerWidth - b.menuWidth / 2
                                                ? (i = !0)
                                                : d >=
                                                      window.innerWidth -
                                                          b.menuWidth / 2 &&
        ...
        a.fn.sideNav = function (c) {
            return b[c]
                ...
                : "object" != typeof c && c
                ? void a.error(
                      "Method " + c + " does not exist on jQuery.sideNav"
                  )
                : b.init.apply(this, arguments);
        };
    })(jQuery),
    (function (a) {
        ...
        function c(c) {
            ...
            a.each(l, function (a, b) {
                ...
                a.each(g, function (a, b) {
                    ...
                    "number" == typeof c &&
                        c !== i &&
                        (b.triggerHandler("scrollSpy:exit"),
        ...
        (a.scrollSpy = function (b, d) {
            ...
            (b = a(b)),
                b.each(function (b, c) {
                    f.push(a(c)),
                        ...
                        a('a[href="#' + a(c).attr("id") + '"]').click(function (
                            b
                        ) {
                            b.preventDefault();
                            var c =
                                a(Materialize.escapeHash(this.hash)).offset()
                                    .top + 1;
                            a("html, body").animate(
            ...
            return (
                h || (e.on("scroll", l), e.on("resize", l), (h = !0)),
                setTimeout(l, 0),
                b.on("scrollSpy:enter", function () {
                    ...
                    var b = a(this);
                    i[0]
                        ? (a('a[href="#' + i[0].attr("id") + '"]').removeClass(
                              "active"
                          ),
                          b.data("scrollSpy:id") < i[0].data("scrollSpy:id")
                              ? i.unshift(a(this))
                              : i.push(a(this)))
                        : i.push(a(this)),
                        a('a[href="#' + i[0].attr("id") + '"]').addClass(
                            "active"
                        );
                }),
        ...
        a(document).ready(function () {
            function b(b) {
                ...
                e.html(g),
                    b.is(":visible")
                        ? e.css("width", b.width())
                        : e.css("width", a(window).width() / 2),
                    b.data("original-height") <= e.height()
                        ? b.css("height", e.height())
                        : b.val().length < b.data("previous-length") &&
                          b.css("height", b.data("original-height")),
            ...
            Materialize.updateTextFields = function () {
                ...
                a(b).each(function (b, c) {
                    ...
                    a(c).val().length > 0 ||
                    c.autofocus ||
                    void 0 !== d.attr("placeholder")
                        ? d.siblings("label").addClass("active")
                        : a(c)[0].validity
                        ? d
                              .siblings("label")
                              .toggleClass(
                                  "active",
                                  a(c)[0].validity.badInput === !0
                              )
                        : d.siblings("label").removeClass("active");
                });
            };
            var c =
                "input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";
            a(document).on("change", c, function () {
                ...
                a(document).on("reset", function (b) {
                    ...
                    d.is("form") &&
                        ...
                        d.find(c).each(function () {
                            "" === a(this).attr("value") &&
                                a(this).siblings("label").removeClass("active");
                        }),
                ...
                a(document).on("blur", c, function () {
                    var b = a(this),
                        c = ".prefix";
                    0 === b.val().length &&
                        b[0].validity.badInput !== !0 &&
                        void 0 === b.attr("placeholder") &&
                        (c += ", label"),
                ...
                (window.validate_field = function (a) {
                    ...
                    0 === a.val().length && a[0].validity.badInput === !1
                        ? a.hasClass("validate") &&
                          (a.removeClass("valid"), a.removeClass("invalid"))
                        : a.hasClass("validate") &&
                          ((a.is(":valid") && b && d <= c) ||
                          (a.is(":valid") && !b)
                              ? (a.removeClass("invalid"), a.addClass("valid"))
                              : (a.removeClass("valid"),
                                a.addClass("invalid")));
                });
            ...
            e.length ||
                ((e = a('<div class="hiddendiv common"></div>')),
                a("body").append(e));
            ...
            a(f).each(function () {
                ...
                a(document).on(
                    ...
                    function () {
                        for (
                            var b = a(this).closest(".file-field"),
                                c = b.find("input.file-path"),
                                d = a(this)[0].files,
                                e = [],
                                f = 0;
                            f < d.length;
                                    ...
                                    j.on(
                                        ...
                                        function () {
                                            ...
                                            d.val(c),
                                                ...
                                                m(),
                                                "function" ==
                                                    typeof b.onAutocomplete &&
                                                    b.onAutocomplete.call(
                                                        this,
                                                        c
                                                    );
                                        }
                ...
                a(this).each(function () {
                    ...
                    if (!d.hasClass("browser-default")) {
                        ...
                        d.before(q),
                            q.before(o),
                            q.after(i),
                            d.is(":disabled") || q.dropdown({ hover: !1 }),
                            d.attr("tabindex") &&
                                a(q[0]).attr("tabindex", d.attr("tabindex")),
                            d.addClass("initialized"),
                            q.on({
                                focus: function () {
                                    if (
                                        (a("ul.select-dropdown")
                                            .not(i[0])
                                            .is(":visible") &&
                                            a("input.select-dropdown").trigger(
                                                "close"
                                            ),
                                        !i.is(":visible"))
                                    ) {
        ...
        a(document).ready(function () {
            a(document).on("click.card", ".card", function (b) {
                a(this).find("> .card-reveal").length &&
                    ...
                    a(b.target).is(a(".card-reveal .card-title i"))
                        ? a(this)
                              .find(".card-reveal")
                              .velocity(
                                  { translateY: 0 },
                        ...
                        : (a(b.target).is(a(".card .activator")) ||
                              a(b.target).is(a(".card .activator i"))) &&
                          (a(b.target)
                              .closest(".card")
                              .css("overflow", "hidden"),
                          a(this)
    ...
    (function (a) {
        ...
        a(document).ready(function () {
            ...
            (a.fn.material_chip = function (c) {
                ...
                var e = a.extend({}, b, c);
                (d.hasAutocomplete = !a.isEmptyObject(
                    e.autocompleteOptions.data
                )),
                    (this.init = function () {
                        var b = 0;
                        d.$el.each(function () {
                            var c = a(this),
                                f = Materialize.guid();
                            (d.chipId = f),
                                (e.data && e.data instanceof Array) ||
                                    (e.data = []),
                                c.data("chips", e.data),
                                c.attr("data-index", b),
                    ...
                    (this.handleEvents = function () {
                        ...
                        d.$document
                            ...
                            d.$document
                                .off("focusin.chips", b.CHIPS + " " + b.INPUT)
                                .on(
                                    "focusin.chips",
                                    b.CHIPS + " " + b.INPUT,
                                    function (c) {
                            ...
                            d.$document
                                .off("focusout.chips", b.CHIPS + " " + b.INPUT)
                                .on(
                                    "focusout.chips",
                                    b.CHIPS + " " + b.INPUT,
                                    function (c) {
                    ...
                    (this.chips = function (b, c) {
                        ...
                        var g = a("#" + c);
                        d.hasAutocomplete &&
                            ((e.autocompleteOptions.onAutocomplete = function (
                                a
                            ) {
                    ...
                    (this.setPlaceholder = function (a) {
                        a.data("chips").length && e.placeholder
                            ? a.find("input").prop("placeholder", e.placeholder)
                            : !a.data("chips").length &&
                      ...
                      function d(d, e) {
                          d.each(function () {
                              b.top <= e &&
                                  ...
                                  e < b.top &&
                                      !a(this).hasClass("pin-top") &&
                                      (c(a(this)),
                                      a(this).css("top", 0),
                                      a(this).addClass("pin-top")),
                                  e > b.bottom &&
                                      !a(this).hasClass("pin-bottom") &&
                                      (c(a(this)),
                ...
                c
                    ...
                    c.find("li").each(function () {
                        a(this).velocity(
                            ...
                            { duration: 800, delay: d, easing: [60, 10] }
                        ),
                            (d += 120);
                    });
            }),
    ...
    (function (a) {
        ...
        Materialize.scrollFire = function (a) {
            var c = function () {
                    for (
                        var b = window.pageYOffset + window.innerHeight, c = 0;
                        c < a.length;
                        c++
                    ) {
                        var d = a[c],
            ...
            function m() {
                return b._.node(
                    ...
                    b._.node(
                        ...
                        b._.node(
                            "div",
                            b._.node("div", y.component.nodes(t.open), v.box),
                            v.wrap
                        ),
                        v.frame
                    ),
                    ...
                    .on(
                        ...
                        function () {
                            var b = a(this),
                                c = b.data(),
                                d =
                                    b.hasClass(v.navDisabled) ||
                                    b.hasClass(v.disabled),
                                e = h();
                            (e = e && (e.type || e.href)),
                                (d || (e && !a.contains(y.$root[0], e))) &&
                                    y.$root.eq(0).focus(),
                                !d && c.nav
                                    ? y.set(
                                          "highlight",
                    ...
                    (y._hidden = a(
                        '<input type=hidden name="' +
                            ...
                            (w.data("value") || f.value
                                ? ' value="' +
                                  y.get("select", u.formatSubmit) +
                                  '"'
                                : "") +
                            ">"
                    )[0]),
                    w.on("change." + t.id, function () {
                        y._hidden.value = f.value
                            ? y.get("select", u.formatSubmit)
                            : "";
                    }),
                    u.container
                        ? a(u.container).append(y._hidden)
                        : w.after(y._hidden);
            }
            function q(a) {
                var b = a.keyCode,
                ...
                return 27 == b
                    ? (y.close(), !1)
                    : void (
                          (32 == b || c || (!t.open && y.component.key[b])) &&
                          (a.preventDefault(),
                          a.stopPropagation(),
        ...
        return (
            ...
            (b._ = {
                ...
                isInteger: function (a) {
                    return (
                        {}.toString.call(a).indexOf("Number") > -1 &&
                        a % 1 === 0
                    );
                },
                ariaAttr: g,
    ...
    (function (a) {
        ...
        (c.prototype.set = function (a, b, c) {
            ...
            return null === b
                ...
                : ((e["enable" == a ? "disable" : "flip" == a ? "enable" : a] =
                      d.queue[a]
                          .split(" ")
                          .map(function (e) {
                              return (b = d[e](a, b, c));
    ...
    (function (a) {
        ...
        function e(a, b) {
            ...
            a && c
                ...
                : a || c || (b.removeClass("valid"), b.addClass("invalid"));
        }
    ...
    (function (a) {
                ...
                return this.each(function (c) {
                    function e() {
                        "undefined" != typeof window.ontouchstart &&
                            (O[0].addEventListener("touchstart", n),
                    ...
                    function f(a) {
                        return a.targetTouches && a.targetTouches.length >= 1
                    ...
                    function i(c) {
                        ...
                        for (
                            (!b.noWrap || (u >= 0 && u < x)) &&
                                ((j = q[h(u)]),
                                a(j).hasClass("active") ||
                                    (O.find(".carousel-item").removeClass(
                                        "active"
                                    ),
                                    a(j).addClass("active")),
                                (j.style[F] =
                            ...
                            b.fullWidth
                                ? ((zTranslation = b.dist),
                                  (tweenedOpacity =
                                      d === e && f < 0 ? 1 - i : 1))
                                : ((zTranslation = b.dist * (2 * d + i * g)),
                                  (tweenedOpacity = 1 - 0.2 * (2 * d + i * g))),
                                (!b.noWrap || u + d < x) &&
                                    ((j = q[h(u + d)]),
                                    (j.style[F] =
                                        k +
                    ...
                    function m(a) {
                        ...
                        b.noWrap ||
                            (c < 0
                                ? Math.abs(c + x) < Math.abs(c) && (c += x)
                                : c > 0 && Math.abs(c - x) < c && (c -= x)),
                            c < 0
                                ? O.trigger("carouselNext", [Math.abs(c)])
                                : c > 0 && O.trigger("carouselPrev", [c]);
                    }
                    function n(a) {
                        a.preventDefault(),
                            (v = !0),
                    ...
                    var q,
                        ...
                        Q = function () {
                            ...
                            if (b.length)
                                b.prop("complete")
                                    ? O.css("height", b.height())
                                    : b.on("load", function () {
                                          O.css("height", a(this).height());
                                      });
                            else {
                                var c = O.find(".carousel-item")
                                    .first()
                                    .height();
                                O.css("height", c);
                            }
                    ...
                    return (
                        b.fullWidth &&
                            ...
                            Q(),
                            P &&
                                O.find(".carousel-fixed-item").addClass(
                                    "with-indicators"
                                )),
                        O.hasClass("initialized")
                            ...
                            : (O.addClass("initialized"),
                              ...
                              (t = C = 0),
                              (q = []),
                              (r = O.find(".carousel-item")
                                  .first()
                                  .innerWidth()),
                              (s = O.find(".carousel-item")
                                  .first()
                                  .innerHeight()),
                              (w = 2 * r + b.padding),
                              ...
                              ["webkit", "Moz", "O", "ms"].every(function (a) {
                                  ...
                                  return (
                                      "undefined" ==
                                          typeof document.body.style[b] ||
                                      ((F = b), !1)
                                  );
                              }),
                              a(window)
                                  .off("resize.carousel-" + L)
                                  .on("resize.carousel-" + L, function () {
                                      b.fullWidth
                                          ? ((r = O.find(".carousel-item")
                                                .first()
                                                .innerWidth()),
        ...
        a.fn.carousel = function (c) {
            return b[c]
                ...
                : "object" != typeof c && c
                ? void a.error(
                      "Method " + c + " does not exist on jQuery.carousel"
                  )
                : b.init.apply(this, arguments);
        };
    })(jQuery),
    (function (a) {
        var b = {
            init: function (b) {
                return this.each(function () {
                    ...
                    e.length ||
                        (e = d
                            .wrap(a('<div class="tap-target-wrapper"></div>'))
                            .parent()),
                        h.length ||
                            ((h = a('<div class="tap-target-content"></div>')),
                            d.append(h)),
                        f.length ||
                            ((f = a('<div class="tap-target-wave"></div>')),
                            g.length ||
                                ((g = c.clone(!0, !0)),
                        ...
                        k = function () {
                            ...
                            if (!b)
                                for (
                                    var g = c.parents(), i = 0;
                                    i < g.length &&
                                    !(b = "fixed" == a(g[i]).css("position"));
                                    i++
                                );
                            var j = c.outerWidth(),
                                k = c.outerHeight(),
                                l = b
                                    ? c.offset().top - a(document).scrollTop()
                                    : c.offset().top,
                                m = b
                                    ? c.offset().left - a(document).scrollLeft()
                                    : c.offset().left,
                                n = a(window).width(),
                                o = a(window).height(),
                                p = n / 2,
        ...
        a.fn.tapTarget = function (c) {
            return b[c] || "object" == typeof c
                ? b.init.apply(this, arguments)
                : void a.error(
                      "Method " + c + " does not exist on jQuery.tap-target"
                  );
        };
    })(jQuery);
